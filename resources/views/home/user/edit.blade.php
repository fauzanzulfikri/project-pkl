                            ...
                            <div class="card-body">
                                <form action="/user/{{$user->id}}/update" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="nama" placeholder="Masukan Untuk Nama" value="{{$user->nama}}">
                                    </div>
                                    @error('nama')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="username" class="form-control" name="username" placeholder="Masukan Untuk Username" value="{{$user->username}}">
                                    </div>
                                    @error('username')
                                    <div class="alert alert-danger">{{$message}}</div>
                                    @enderror
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="level" class="form-control">
                                            ...
                                            <option value="pelapor" {{ old('level', $user->level) == 'pelapor' ? 'selected' : '' }}>Pelapor</option>
